...
text = wikipedia.page("АСУ").content
words = nltk.word_tokenize(text)
make_markov_model(words)
m = make_higher_order_markov_model(2,words)
print(generate_random_sentence(5,m))